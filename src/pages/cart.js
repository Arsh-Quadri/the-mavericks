...
export default function cartPage() {
    const { cartCount, formattedTotalPrice, cartDetails, clearCart, redirectToCheckout } = useShoppingCart();
            ...
            {cartCount > 0 ? (
                ...
                <>
                    ...
                    <p className="mt-1 text-xl">
                        ...
                        <Link href="/" className="text-blue-500 underline">here!</Link>
                    </p>
                </>
            )}
